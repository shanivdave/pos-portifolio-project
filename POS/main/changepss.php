...
<div class="container-fluid">
	...
	<div class="span2">
          <div class="well sidebar-nav">
		   ...
		   <li><a class="nav-link" href="chart.php">Category Chart</a></li><br>
			...
			<li class="active"><a href="changepss.php"><i class="icon-exchange icon-2x"></i> Change Password</a> </li>
			<br><br><br><br><br><br>		
			<li>
	...
	<div class="contentheader">
			<i class="icon-table"></i> Change Password
			</div>
			<ul class="breadcrumb">
...
?>
<link href="../style.css" media="screen" rel="stylesheet" type="text/css" />
<form action="savepass.php" method="post" enctype="multipart/form-data">
<center><h4><i class="icon-edit icon-large"></i>Change Password</h4></center>
<hr>
<div id="ac">
<input type="hidden" name="memi" value="<?php echo $id; ?>" />
<span>Old Password: </span><input type="text" style="width:265px; height:30px;"  name="old" Required /><br>
<span>New Password: </span><input type="text" style="width:265px; height:30px;"  name="new" Required /><br>  
<span>Confirm Password: </span><input type="text" style="width:265px; height:30px;"  name="confirmpassword" Required /><br> 

<button  class="btn btn-success btn-block btn-large" style="width:267px;"><i class="icon icon-save icon-large"></i> Change Password</button>
