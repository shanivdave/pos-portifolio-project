...
<div class="span2">
          <div class="well sidebar-nav">
			...
			<li class="active"><a href="products.php"><i class="icon-list-alt icon-2x"></i> Products</a>
			<ul class="dropdown">
...
<a  href="index.php"><button class="btn btn-default btn-large" style="float: left;"><i class="icon icon-circle-arrow-left icon-large"></i> Back</button></a>
			...
			Total Number of unit:  <font color="green" style="font:bold 22px 'Aleo';">[<?php echo $rowcount;?>]</font>
			</div>
</div>


<input type="text" style="height:35px; color:#222;" name="filter" value="" id="filter" placeholder="Search Category..." autocomplete="off" />
<a rel="facebox" href="addunit.php"><Button type="submit" class="btn btn-info" style="float:right; width:230px; height:35px;" /><i class="icon-plus-sign icon-large"></i> Add Product</button></a><br><br>
<table class="hoverTable" id="resultTable" data-responsive="table" style="text-align: left;">
	...
	<tbody>
			...
			<?php
				include('../connect.php');
				$result = $db->prepare("SELECT * FROM unit ORDER BY unit_id ASC");
				$result->execute();
			...
			<td>
			<a href="#" id="<?php echo $row['unit_id']; ?>" class="delbutton" title="Click to Delete the Category"><button class="btn btn-danger"><i class="">Delete</i></button></a></td>
			</tr>
			<?php
				}
			?>
