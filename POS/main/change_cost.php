...
<div class="container-fluid">
	...
	<div class="contentheader">
			<i class="icon-table"></i> Change Price
			</div>
			<ul class="breadcrumb">
...
?>
<link href="../style.css" media="screen" rel="stylesheet" type="text/css" />
<form action="savecost.php" method="post" enctype="multipart/form-data">
<center><h4><i class="icon-edit icon-large"></i>change price</h4></center>
<hr>
<div id="ac">
<input type="hidden" name="memi" value="<?php echo $id; ?>" />
<span>Previous Cost: Eg; 20: </span><input type="text" style="width:265px; height:30px;"  name="prev" Required /><br>
<span>New Cost: Eg; 30: </span><input type="text" style="width:265px; height:30px;"  name="new" Required /><br>	

<button  class="btn btn-success btn-block btn-large" style="width:267px;"><i class="icon icon-save icon-large"></i> Save product</button>
