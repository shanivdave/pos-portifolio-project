...
<hr>
<div id="ac">
<span>Item Code : </span><input type="text" style="width:265px; height:30px;" value="TBH-<?php 
...
<select name="name" style="width:265px; height:30px; margin-left:-5px;" >
  <option></option>
  <option disabled>timber cyprus</option>
  <option>1*1/2</option>
  <option>2*1 </option>
  <option>3*1</option>
  <option>4*1</option>
  ...
  <option>3*2</option>
  <option>4*2</option>
  <option disabled>faceboard</option>
  <option>6*1 </option>
  <option>8*1</option>
  <option disabled>timber bluegum</option>
  <option>2*1 </option>
  <option>6*1</option>
  <option>2*2</option>
  <option>3*2</option>
  <option>bluegum posts</option>
  <option>poles</option>
  <option disabled>faceboard</option>
  <option>8*1</option>.
  ...
  <option>door locks</option>
  <option>hiches</option>
  <option>tower bolts</option>
  <option disabled>frames</option>
  <option>2*2 </option>
  <option>3*2</option>
  <option>4*2</option>
  <option disabled>hardware</option>
  <option>nails ordinary </option>
  <option>nails polished</option>
  <option>MDF</option>
  <option>plywood</option>
  <option>marineboard</option>
  <option>6mm ply</option>
  <option>ceiling boards</option>
  <option>flowed ceiling</option>
</select><br>
<span>Category : </span>
...
<span>Unit : </span>
<select name="unit_name"  style="width:265px; height:30px; margin-left:-5px;" >
<option></option>
  <?php
  include('../connect.php');
  $result = $db->prepare("SELECT * FROM unit");
    $result->bindParam(':userid', $res);
    $result->execute();
    for($i=0; $row = $result->fetch(); $i++){
  ?>
